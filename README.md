...
- `fetch_contract_markets(self, params: Any)`
...
- `fetch_orders_by_status(self, status: Any, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `fetch_spot_markets(self, params: Any)`
...
- `modify_margin_helper(self, symbol: str, amount: Any, addOrReduce: Any, params={})`
- `nonce(self)`
