...
- `create_deposit_address(self, code: str, params: dict = {})`
...
- `fetch_borrow_interest(self, code: Str = None, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_contract_markets(self, params: object)`
- `fetch_currencies(self, params: dict = {})`
- `fetch_deposit_address(self, code: str, params: dict = {})`
- `fetch_deposit_withdraw_fee(self, code: str, params: dict = {})`
- `fetch_deposit_withdraw_fees(self, codes: Strings = None, params: dict = {})`
- `fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_financial_balance(self, params: dict = {})`
- `fetch_funding_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_funding_interval(self, symbol: str, params: dict = {})`
...
- `fetch_isolated_borrow_rate(self, symbol: str, params: dict = {})`
- `fetch_leverage_tiers(self, symbols: Strings = None, params: dict = {})`
- `fetch_leverage(self, symbol: str, params: dict = {})`
- `fetch_margin_adjustment_history(self, symbol: Str = None, type: Str = None, since: Num = None, limit: Num = None, params: dict = {})`
- `fetch_margin_balance(self, params: dict = {})`
...
- `fetch_order_book(self, symbol: str, limit: Int = 20, params: dict = {})`
- `fetch_order(self, id: str, symbol: Str = None, params: dict = {})`
- `fetch_orders_by_status(self, status: object, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_position_history(self, symbol: str, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_position(self, symbol: str, params: dict = {})`
- `fetch_positions(self, symbols: Strings = None, params: dict = {})`
- `fetch_spot_balance(self, params: dict = {})`
- `fetch_spot_markets(self, params: object)`
- `fetch_swap_balance(self, params: dict = {})`
...
- `fetch_transfers(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `borrow_isolated_margin(self, symbol: str, code: str, amount: float, params: dict = {})`
...
- `close_position(self, symbol: str, side: OrderSide = None, params: dict = {})`
- `describe(self)`
- `edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params: dict = {})`
- `edit_orders(self, orders: list[OrderRequest], params: dict = {})`
- `modify_margin_helper(self, symbol: str, amount: Num, addOrReduce: Str, params: dict = {})`
- `nonce(self)`
- `reduce_margin(self, symbol: str, amount: float, params: dict = {})`
- `repay_isolated_margin(self, symbol: str, code: str, amount: float, params: dict = {})`
...
- `v2_public_get_assets_info(request)`
...
- `v2_private_post_futures_modify_position_stop_loss(request)`
- `v2_private_post_futures_modify_position_take_profit(request)`
...
- `watch_ticker(self, symbol: str, params: dict = {})`
- `watch_tickers(self, symbols: Strings = None, params: dict = {})`
- `watch_trades(self, symbol: str, since: Int = None, limit: Int = None, params: dict = {})`
- `watch_trades_for_symbols(self, symbols: list[str], since: Int = None, limit: Int = None, params: dict = {})`
- `watch_order_book_for_symbols(self, symbols: list[str], limit: Int = None, params: dict = {})`
...
- `watch_bids_asks(self, symbols: Strings = None, params: dict = {})`
