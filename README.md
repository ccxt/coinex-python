...
- `create_order_request(self, symbol: Str, type: Str, side: Str, amount: Num, price: Num = None, params={})`
...
- `fetch_orders_by_status(self, status: object, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `modify_margin_helper(self, symbol: str, amount: object, addOrReduce: object, params={})`
- `nonce(self)`
- `reduce_margin(self, symbol: str, amount: float, params={})`
- `repay_isolated_margin(self, symbol: str, code: str, amount: float, params={})`
